...
h = 0.55; %decay parameter %if it is small enough, change the value of it, the image will not change
windowSize = 5;
...
filtered = nonLocalMeansIntegralImage(image, sigma, h, patchSize, windowSize);
toc
